...
_wt_generate_config() {
  local _main="$1" _by="${2:-ddev-wt}" _detected="" _remote_url _ddev_name
...
# Auto-generated by ddev-wt. Do not edit manually — regenerated on
